...
def get_cifar10_dataloaders(args, validation_split=0.0, max_threads=10, hessian=False):
    ...
    full_dataset = datasets.CIFAR10('./data', True, train_transform, download=True)
    test_dataset = datasets.CIFAR10('./data', False, test_transform, download=False)

    train_batch_size = args.mini_hessian_batch_size if hessian is True else args.batch_size
    test_batch_size = 1 if hessian is True else args.test_batch_size
...
def get_cifar100_dataloaders(args, validation_split=0.0, max_threads=10, hessian=False):
    """Creates augmented train, validation, and test data loaders."""
